...
Begin VB.Form frmGanancia 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmGanancia.frx":57E2
      Left            =   6420
      List            =   "frmGanancia.frx":57EF
      TabIndex        =   10
...
titulos = " Número|Fecha|VENDEDOR|CLIENTE|TIPO VENTA|TOTAL|COSTO REP.|GANANCIA"
...
strSql = "SELECT * FROM FacturasX WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY NumFact ASC"
ElseIf Combo1.Text = "Facturas A" Then
strSql = "SELECT * FROM FacturasA WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY NumFact ASC"
ElseIf Combo1.Text = "Facturas B" Then
strSql = "SELECT * FROM FacturasB WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY NumFact ASC"
End If
...
'strSql = "SELECT * FROM Utilidad WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY ID ASC"
If Combo1.Text = "Ordenes de Pedido" Then
strSql = "SELECT * FROM FacturasX WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY NumFact ASC"
ElseIf Combo1.Text = "Facturas A" Then
strSql = "SELECT * FROM FacturasA WHERE FECHA BETWEEN " & strDesde & " AND " & strHasta & "ORDER BY NumFact ASC"
...
Printer.CurrentX = 2 + (Val(LongitudCod)) - (Printer.TextWidth(Format(RstSocios!numfact, "0###")))
Printer.Print Format(RstSocios!numfact, "0###");
...
'    Printer.CurrentX = 6
'       Printer.Print Left(RstSocios!VENDEDOR, 22);
...
Printer.CurrentX = 15 + (Val(Longitud2)) - (Printer.TextWidth(Format(RstSocios!total, "#,###.#0")))
Printer.Print Format(RstSocios!total, "#,###.#0");
...
TotVent = TotVent + RstSocios!total
...
'strSql = "SELECT * FROM Utilidad Where ID=" & Val(itemselecto)
