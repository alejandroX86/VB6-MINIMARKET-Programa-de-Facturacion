...
Begin VB.Form frmVendedores 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":075E
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":0BB2
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":1006
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":145A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":18AE
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":1D02
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":2156
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmVendedores.frx":25AA
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnuArchivo 
      ...
      Begin VB.Menu mnuImprimir 
         Caption         =   "&Imprimir Ficha Vendedor"
         Shortcut        =   ^P
      End
...
Private Sub TraigoDatos()
  On Error Resume Next
    ...
    txtNombre.Text = RTrim(rs!nombre)
        ...
        txtDireccion.Text = RTrim(rs!Direccion)
...
SendKeys ("{tab}")
KeyAscii = 0
ElseIf KeyAscii = 8 And txtDireccion = "" Then
txtNombre.SetFocus
KeyAscii = 0
End If
End Sub
...
Private Sub tbNroDoc_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
SendKeys ("{tab}")
KeyAscii = 0
ElseIf KeyAscii = 8 And TbNroDoc = "" Then
TbTipDoc.SetFocus
KeyAscii = 0
...
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
'TODO ESTO ES PARA ANIMAR EL COMBO Tipo de doc
