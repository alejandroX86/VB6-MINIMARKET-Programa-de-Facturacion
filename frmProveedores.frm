...
Begin VB.Form frmProveedores 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboCategIva 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmProveedores.frx":0442
         Left            =   7500
         List            =   "frmProveedores.frx":0458
         TabIndex        =   9
      ...
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
         Bindings        =   "frmProveedores.frx":04DC
         Height          =   3075
         Left            =   240
         TabIndex        =   35
         Top             =   2940
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":04F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":0946
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":0D9A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":11EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":1642
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":1A96
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":1EEA
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":233E
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmProveedores.frx":2792
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Dim strSql As String
strSql = "SELECT * FROM Proveedores WHERE ID =" & Val(txtCodDist)
rs.Open strSql, DB, adOpenKeyset, adLockOptimistic, adCmdText
...
titulos = "Nº FACT.|FECHA|COND. VENTA|TOTAL"
...
Wend
lblTotalRef = rsCons.RecordCount
lblTotal = "Saldo Cta/Cte: $ " & Format(TotDebe - TotHaber, "#,###.#0")
...
MSHFlexGrid1.Col = 5
If Option2.Value = True And Val(MSHFlexGrid1.Text) > 0 Then
frmInputPago.Show
