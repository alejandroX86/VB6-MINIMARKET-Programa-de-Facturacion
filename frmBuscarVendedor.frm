...
Begin VB.Form frmBuscarVendedor 
   BackColor       =   &H00000000&
   Caption         =   "Consultar Vendedores"
   ClientHeight    =   5745
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   8550
   Icon            =   "frmBuscarVendedor.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5745
   ScaleWidth      =   8550
   ...
   End
End
Attribute VB_Name = "frmBuscarVendedor"
...
titulos = " Codigo.|Nombre|Dirección|Telefono|E-mail"
 MSHFlexGrid1.Clear
    With MSHFlexGrid1
        .Rows = 2
        .FixedRows = 1
...
Case "Direccion"
    If txtBuscar <> "" Then
    rs.Filter = "Direccion LIKE '*" + txtBuscar + "*'"
    Else
    rs.Filter = ""
    End If
...
MSHFlexGrid1.Col = 0
frmVendedores.txtID.Text = MSHFlexGrid1.Text
MSHFlexGrid1.Col = 1
frmVendedores.txtNombre.Text = MSHFlexGrid1.Text
MSHFlexGrid1.Col = 2
frmVendedores.txtDireccion.Text = MSHFlexGrid1.Text
MSHFlexGrid1.Col = 3
frmVendedores.txtTelefono.Text = MSHFlexGrid1.Text
MSHFlexGrid1.Col = 4
frmVendedores.txtEmail.Text = MSHFlexGrid1.Text

frmVendedores.txtID.Enabled = True
frmVendedores.txtID.SetFocus
Unload Me
